// script.js (ES module) — FULL (LOCKED + BEACH + FOOD)
...
/* ===========================
   VIBE IMAGES (LOCKED)
   Swap URLs anytime to your final selected set.
=========================== */
const VIBE_IMAGES = {
  city:
  ...
  food:
    "https://images.unsplash.com/photo-1556912167-f556f1f39df8?auto=format&fit=crop&w=2000&q=70"
};
...
const THEMES = {
  ...
  beach:  { bg1:"#243b4a", bg2:"#060e14", a1:"#67e8f9", a2:"#a5f3fc" },
...
/* ===========================
   PEOPLE (demo)
   Stable avatars, gender-match, no click swap bug
=========================== */
function kmMin1(km){
...
const PEOPLE_BY_VIBE = {
  ...
  beach: [
    { name:"Tara", age:28, gender:"f", bio:"Beach walk • salty air", km:0.8, avatarId:12 },
    { name:"Benji",age:35, gender:"m", bio:"Sunset chats • no rush", km:1.7, avatarId:46 },
    { name:"Amir", age:44, gender:"m", bio:"Ocean swim • calm energy", km:3.2, avatarId:31 },
    { name:"Kira", age:40, gender:"f", bio:"Coffee after the coast", km:2.2, avatarId:59 },
    { name:"Jules",age:33, gender:"m", bio:"Boardies + books", km:4.4, avatarId:77 }
  ],
  food: [
