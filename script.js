// script.js (ES module) — FULL (LOCKED + 6 VIBES)
...
/* ===========================
   VIBE IMAGES (LOCKED — swap anytime)
=========================== */
const VIBE_IMAGES = {
...
const THEMES = {
  ...
  beach:  { bg1:"#224454", bg2:"#061019", a1:"#67e8f9", a2:"#a7f3d0" },
...
// Deterministic unique avatars (0..99)
...
const PEOPLE_BY_VIBE = {
  ...
  beach: [
    { name:"Tara", age:28, gender:"f", bio:"Beach walk • salty air", km:0.9, avatarId:12 },
    { name:"Benji",age:35, gender:"m", bio:"Sunset chats • no rush", km:1.7, avatarId:31 },
    { name:"Amir", age:44, gender:"m", bio:"Ocean swim • calm energy", km:3.2, avatarId:56 },
    { name:"Kira", age:40, gender:"f", bio:"Coffee after the coast", km:2.6, avatarId:44 },
    { name:"Jess", age:33, gender:"f", bio:"Towels down • good tunes", km:4.5, avatarId:73 }
  ],
  food: [
