...
/* ===========================
   VIBE IMAGES
   (Fitness = runners)
   (Tech = girl on laptop/coding vibe)
=========================== */
const VIBE_IMAGES = {
  city:
...
/* ===========================
   PEOPLE (demo, 1km min)
   Fitness: include runners (imagine running with someone)
   Tech: include a girl on laptop/gaming/coding vibe
=========================== */
function kmMin1(km){
...
const PEOPLE_BY_VIBE = {
  ...
  tech: [
    { name:"Ava", age:26, bio:"Laptop open • building things", km:0.8 },   // girl on laptop
    { name:"Nina", age:32, bio:"Gaming night • chill co-op?", km:1.9 },     // girl gaming vibe
    { name:"Omar", age:41, bio:"Writing code • coffee fuel", km:3.7 },
    { name:"Sophie", age:29, bio:"Design + dev • headphones on", km:2.4 },  // girl coding/design
