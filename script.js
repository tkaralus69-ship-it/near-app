...
function applyVibe(theme){
  ...
  // IMPORTANT: promo tiles should NOT inherit vibe images
  // (keeps them neutral glass instead of "food for tech")
...
/* ===========================
   PEOPLE (demo, 1km min)
   Avatar images are LOCKED to each person
=========================== */
function kmMin1(km){
...
// These are safe “demo” faces; swap anytime.
// If any URL fails, fallback avatar still shows.
const PEOPLE_BY_VIBE = {
  city: [
    ...
    { name:"Elena", age:27, bio:"Late snack • good chats", km:0.7,
      avatar:"https://images.unsplash.com/photo-1524503033411-f6b9f85f6eab?auto=format&fit=crop&w=200&q=60" },
    { name:"David", age:61, bio:"Just chillin • music on", km:4.9,
      avatar:"https://images.unsplash.com/photo-1542206395-9feb3edaa68d?auto=format&fit=crop&w=200&q=60" }
  ],
  nature: [
    ...
    { name:"Noah", age:36, bio:"Coastal walk • no rush", km:1.8,
      avatar:"https://images.unsplash.com/photo-1552058544-f2b08422138a?auto=format&fit=crop&w=200&q=60" },
    { name:"Lena", age:48, bio:"Bird sounds • calm day", km:2.9,
      avatar:"https://images.unsplash.com/photo-1548142813-c348350df52b?auto=format&fit=crop&w=200&q=60" },
    { name:"Kai", age:33, bio:"Hiking • simple life", km:3.6,
      avatar:"https://images.unsplash.com/photo-1540569014015-19a7be504e3a?auto=format&fit=crop&w=200&q=60" },
    { name:"Rose", age:57, bio:"Tea after a walk", km:4.1,
      avatar:"https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?auto=format&fit=crop&w=200&q=60" }
  ],
  fitness: [
    ...
    { name:"Asha", age:30, bio:"Runner • steady pace", km:1.6,
      avatar:"https://images.unsplash.com/photo-1524502397800-2eeaad7c3fe5?auto=format&fit=crop&w=200&q=60" },
  ...
  tech: [
    // LOCKED: Tech = women + mixed jobs + older dude
  ...
  arr.slice(0,5).forEach(p=>{
    ...
    li.innerHTML = `
      <div class="avatar" aria-hidden="true">
        <img class="avatarImg" src="${p.avatar}" alt="" loading="lazy"
