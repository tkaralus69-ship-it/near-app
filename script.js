// script.js (v4 FULL)
// Promo tiles + vibe buttons now set theme + (optional) tap promo card to switch theme
// Firebase Auth + Location + People Near + Live Waves unchanged.
...
/* Tap promo card switches theme (nice feel) */
