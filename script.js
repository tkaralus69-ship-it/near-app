// script.js (ES module) — FULL (LOCKED / FIX TAP BUG / FOOD ADDED / STABLE AVATARS)
...
const VIBE_IMAGES = {
  ...
  beach:  "https://images.unsplash.com/photo-1500375592092-40eb2168fd21?auto=format&fit=crop&w=2000&q=70",
  ...
  food:   "https://images.unsplash.com/photo-1506368249639-73a05d6f6488?auto=format&fit=crop&w=2000&q=70"
};
...
const THEMES = {
  ...
  food:   { bg1:"#3a2a20", bg2:"#120802", a1:"#fbbf24", a2:"#fb7185" }
};
...
const PEOPLE_BY_VIBE = {
  ...
  food: [
    { name:"Luca",  age:32, gender:"m", bio:"Cooking • real kitchen", km:1.1, avatarId:12 },
    { name:"Maya",  age:27, gender:"f", bio:"Baking • warm energy", km:2.3, avatarId:21 },
    { name:"Renee", age:38, gender:"f", bio:"Dinner plans • slow chats", km:3.8, avatarId:49 },
    { name:"Owen",  age:41, gender:"m", bio:"Coffee + breakfast • easy vibe", km:0.9, avatarId:64 },
    { name:"Sara",  age:35, gender:"f", bio:"Food markets • good laughs", km:4.2, avatarId:77 }
  ]
};
