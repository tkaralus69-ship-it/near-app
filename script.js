// script.js (ES module) — FULL (LOCKED + FIXED PROFILE CLICK GLITCH)
...
/* ===========================
   PEOPLE (demo)
   FIX: clicking profiles should NOT swap a different person
   - We render stable data.
   - We DO NOT attach click handlers that mutate the list.
=========================== */
function kmMin1(km){
...
function renderPeople(vibe){
  usedAvatarKeys.clear(); // makes render stable each time
